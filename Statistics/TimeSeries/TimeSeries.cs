...
namespace Statistics.TimeSeries
{
	public class TimeSeries
	{
		...
		{
			this.values = v;
			this.sampleMean = this.values.Mean ();
			this.sampleVariance = this.values.Variance ();
		...
		{
			this.sampleAutocovarianceFunction = new double[this.values.Length];
			for (int h = 0; h < this.values.Length; h++) {
